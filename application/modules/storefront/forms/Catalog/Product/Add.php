...
class Storefront_Form_Catalog_Product_Add extends SF_Form_Abstract
{
    ...
    {
        //add path to custom validation and filters
        ...
        $this->setMethod('post'); //why set here if set in controller?
        $this->setAction('');

        //get category select from forms
        $form = new Storefront_Form_Catalog_Category_Select(
            array('model' => $this->getModel()) //this model is referring to the SF_Form_Abstract method we implemented
        );

        //load form into element andclear decorators
        ...
        $this->addDisplayGroup(array(
            ...
            'productInfo',
            array('legend' => 'Product Information')
        );
